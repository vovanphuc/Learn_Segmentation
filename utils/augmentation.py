...
class RandomRotation(object):
    ...
    def __call__(self, img, anno_class_img):
        ...
        anno_class_img = anno_class_img(rotate_angle, Image.NEAREST)
...
class Resize(object):
    ...
    def __call__(self,img, anno_class_img):
        img = img.reszie(self.input_size[0], self.input_size[1], Image.BILINEAR)
        anno_class_img = anno_class_img.reszie(self.input_size[0], self.input_size[1], Image.BILINEAR)
